...
{#if isOpen}
  ...
  <div class="modal-overlay" on:click={onCancel} role="presentation">
    <!-- svelte-ignore a11y_click_events_have_key_events -->
    <!-- svelte-ignore a11y_no_static_element_interactions -->
    <div class="modal-content" on:click|stopPropagation role="dialog" aria-modal="true" aria-labelledby="delete-profile-title">
      ...
      <div class="modal-body">
        <div class="warning-message">
          ...
          <p class="warning-subtext">
            This action cannot be undone. The profile will be permanently removed from your account.
          </p>
        </div>
      </div>
